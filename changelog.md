...
- [feature/frontend-add-html-structure] Se agregaron los códigos html, marcas de donde deben ir los css y javascrip. PR: [#12](https://github.com/eternalnight04/HeladeriaVainell/pull/12) - @britezacostaalexis-pixel (Documentador / Diseñador UX)
